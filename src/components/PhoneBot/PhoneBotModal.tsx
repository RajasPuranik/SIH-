                      ...
                      {lastMessage.quickActions.map((action, idx) => {
                        ...
                        return (
                          <button
                            ...
                            className={`absolute top-1/2 left-1/2 shrink-0 px-3 py-1.5 bg-slate-800/95 text-xs font-bold rounded-full border transition-all pointer-events-auto hover:scale-110 whitespace-nowrap ${
                          [

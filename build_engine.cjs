...
const code = `import { CropInfo, SlotBooking } from '../types';
...
fs.writeFileSync('src/services/phoneBotEngine.ts', code, 'utf8');
console.log('phoneBotEngine.ts generated successfully');
